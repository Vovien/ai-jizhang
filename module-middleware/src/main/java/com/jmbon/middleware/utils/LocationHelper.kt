...
class LocationHelper {
    ...
    companion object {
        ...
        fun getLocationCoordinate(context: Context, reason: String = "为了展示更准确的医院信息, 需要获取您的位置权限", listener: (longitude: Double, latitude: Double) -> Unit) {
            if (PermissionUtils.checkPermission(context, mutableListOf(
     ...
     */
    @SuppressLint("MissingPermission")
    fun realGetLocationCoordinate(context: Context, listener: (longitude: Double, latitude: Double) -> Unit) {
