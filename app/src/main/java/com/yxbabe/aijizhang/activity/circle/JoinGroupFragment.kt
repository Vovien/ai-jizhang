package com.yxbabe.aijizhang.activity.circle
...
import com.yxbabe.aijizhang.router.AppRouter
...
import com.yxbabe.aijizhang.adapter.CircleGroupAdapter
import com.yxbabe.aijizhang.databinding.FragmentJoinGroupBinding
import com.yxbabe.aijizhang.viewmodel.JoinGroupViewModel
...
class JoinGroupFragment : ViewModelFragment<JoinGroupViewModel, FragmentJoinGroupBinding>() {
    ...
    override fun initView(view: View) {
        binding.apply {
            ...
            circleAdapter.setEmptyView(R.layout.default_viewstatus_box_empty3)
