...
import com.jmbon.middleware.bury.PageBuryManager
...
import com.yxbabe.aijizhang.databinding.ActivityPrivacyAgreementBinding
        ...
        SpanUtils.with(binding.tvDesc2)
            ...
            .setClickSpan(ColorUtils.getColor(R.color.color_currency), false) {
                ARouter.getInstance().build("/webview/activity")
                    .withString("url", "https://m.jmbon.com/about/74")
            ...
            .setClickSpan(ColorUtils.getColor(R.color.color_currency), false) {
                ARouter.getInstance().build("/webview/activity")
                    .withString("url", "https://m.jmbon.com/about/75")
...
//                }
    ...
    private val PROCESS = "com.yxbabe.aijizhang"
