package com.yxbabe.aijizhang.api
...
object MainApi {
    ...
    suspend fun getKnowledgeInfo(): KnowledgeBean {
        return HttpBusiness.post("api/tab/knowledge")
    ...
    suspend fun getHelperGroupList(type: Int, page: Int, pageSize: Int = 10): HelpGroupBean {
        return HttpBusiness.post("api/tab/group/cate/info")
            .add("cate_id", type)
//            .add("page", page)
//            .add("page_size", pageSize)
    ...
    suspend fun getCircleConfig(): CircleConfigBean {
        return HttpBusiness.post("api/tab/group")
